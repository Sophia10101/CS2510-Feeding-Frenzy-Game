...
class ExamplesAnimation {
  ...
  Dot d4 = new Dot(10, Color.black, new Random(20));
  ...
  boolean testDraw(Tester t) {
    return t.checkExpect(this.d4.draw(this.ws), 
        ...
        && t.checkExpect(this.dw.makeScene(), 
            new WorldScene(600, 400).placeImageXY(new CircleImage(10, "solid", Color.magenta), 58, 239));
  }
  
  boolean testMove(Tester t) {
    return t.checkExpect(this.d4.move(), new Dot(10, Color.black, 58, 239))
        && t.checkExpect(new ConsLoDot(this.d4, this.mt).move(), 
            new ConsLoDot(new Dot(10, Color.black, 58, 239), this.mt));
  }
